...
//~~~~~~~~~~~~~~~~~~~~~~~~//
    ...
    { return (b2Circle){{0.f, 0.f}, radius}; }

    b2Circle NewOffsetCirc(float cx, float cy, float radius)
    { return (b2Circle){{cx, cy}, radius}; }

    b2Capsule NewCapsule(float r, float d, float a) {
        float x, y; x = cosf(a) * d; y = sinf(a) * d;
        return (b2Capsule){{x, y}, {-x, -y}, r};
    }
//~~~~~~~~~~~~~~~~~~~~~~~~//
//==============================================================//
//~~~~~~~~~~~~~~~~~~~~~~~~//
...
//~~~~~~~~~~~~~~~~~~~~~~~~//
    ...
    void UpdateGrab(Vector2f pos) {
        ...
        { GrabJointId = b2_nullJointId; return; }
...
//~~~~~~~~~~~~~~~~~~~~~~~~//
    ...
    { auto data = (TaskData*)context; data->box2dTask(start, end, threadIndex, data->box2dContext); }
